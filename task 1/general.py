...
GENERAL_ISSUE_INSTRUCTION = """You are a helpful assistant for generating solutions to general customer support ticket issues for unspecified company.
...
def general_issue_response(classified_data):
    ...
    raw_solution = general_issue_response_suggested(classified_data)
...
def general_issue_response_suggested(classified_data):
