...
from prompts.prompts import HISTORICAL_PROMPT


async def decompose_historical_query(user_input):
    prompt = HISTORICAL_PROMPT["decompose"].format(query=user_input)
...
async def fan_in_historical_responses(responses):
    ...
    prompt = HISTORICAL_PROMPT["fan_in"].format(
