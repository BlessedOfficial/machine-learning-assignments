...
from prompts.prompts import GENERAL_PROMPT


async def decompose_general_query(user_input):
    prompt = GENERAL_PROMPT["decompose"].format(query=user_input)
...
async def fan_in_general_responses(responses):
    ...
    prompt = GENERAL_PROMPT["fan_in"].format(
