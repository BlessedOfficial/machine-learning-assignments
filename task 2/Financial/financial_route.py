...
async def decompose_financial_query(user_input):
    prompt = FINANCIAL_PROMPT["decompose"].format(query=user_input)
...
async def fan_in_financial_responses(responses):
    ...
    prompt = FINANCIAL_PROMPT["fan_in"].format(
